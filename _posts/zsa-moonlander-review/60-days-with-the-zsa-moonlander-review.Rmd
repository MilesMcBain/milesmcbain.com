...
Even if you're not a massive input nerd, there's a pretty good chance you've heard about the [ZSA Moonlander Ergonomic Keyboard](https://www.zsa.io/moonlander/). It's billed as the next generation of the much vaunted [ErgodoxEZ](https://ergodox-ez.com/) lineage, and like it's predecessor it carries an eye-watering price tag: USD $365.
...
```{r, fig.cap = "My new Moonlander keyboard."}
...
setting and tear down had to be reasonably low effort.
...
to more convenient locations - and the results felt pretty damn good!^[The last layout I made in Oryx is here if you're curious: https://configure.zsa.io/moonlander/layouts/L4P6y/latest/0] This
experience has cemented for me that deep programmability is an important facet
...
```{r, fig.cap = "The diference in spacing between J and N on the Moonlander (right) and my laptop (left)."}
...
So I guess there's some evidence to suggest my hand shape is uncommon. I
...
^[For someone in the US Army. Against warriors of the keyboard kind I expect I'd fare a little better].
...
Around day 60 I got fed up. I'd tried so much and was still experiencing pain. I was
considering even wilder solutions like swapping the left and right halves, when
I had a moment of clarity that my experience was far from what might be
...
hands on the board lying flat in it's stock configuration. These are some of the
