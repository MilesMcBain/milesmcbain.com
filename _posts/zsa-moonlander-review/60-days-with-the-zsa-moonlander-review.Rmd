...
accidentally popped off a keycap trying to squeeze the cables into the slip
...
makes hand movements symmetrical, but I didn't find it universally better as the
hype would have had me believe.
...
some distance from the bottom row of letters.

Rather than being next-generation, this strikes me as something of a regression.
The ErgodoxEZ could tent for all users, while the Moonlander can only tent for a
