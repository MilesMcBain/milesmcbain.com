...
1. I learned of a Spacemacs inspired extension for VSCode: [VSpaceCode](). ^[Thanks to the [Jack of Some YouTube channel](https://www.youtube.com/c/jackofsome)].
...
Spacemacs setup. The first major sticking point was an R package of mine I use many times daily: [`fnamte`](https://github.com/milesmcbain/fnmate)
