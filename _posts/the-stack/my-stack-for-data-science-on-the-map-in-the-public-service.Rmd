...
'Doing', 'Done' type setup. With sparing use of issue tags for cetain
...
The final oberservation is how the dependency graph creates confidence when
...
generates it. This helps avoid innacuracies creeping in due to rework, and
...
Murphy's Law]. The fact that you can quickly pinpoint the exact source code
...
VSCode has pretty great support for R, it's the most popular choice of daily driver in my team [^that's not due to me, I was actually late to the party!].
...
Even in it's current state it's very usable for pair programming. I spent 90
...
teammates remote control of your sceen too, but it's a bit laggy and janky
